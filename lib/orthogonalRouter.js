...
export function computeOrthogonalPath(
  ...
  dist[startIdx] = 0;
  // Seed start direction to match the source stub so Dijkstra prefers
  // continuing straight out of the stub rather than turning immediately.
  // Without this, equal-cost paths that turn at the stub end are chosen
  // arbitrarily, producing unnecessary visible bends after simplification.
  prevDir[startIdx] = srcVertical ? 'v' : 'h';
